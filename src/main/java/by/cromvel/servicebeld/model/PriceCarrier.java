...
/**
 * The persistent class for the tblPriceCarrier database table.
 * 
 */
@Entity
@Table(name = "tblPriceCarrier")
public class PriceCarrier {
	...
	public String getPerev() {
		return this.perev;
	}

	public void setPerev(String perev) {
		this.perev = perev;
	}
